...
function [frame, new_noise_abs2, new_sub_noise_abs2, segSNR, new_Gamma] = processing_frame(frame, prev_in_abs2, noise_abs2, prev_noise_abs2, sub_noise_abs2, Fs, Gamma)
    ...
    [speech, new_Gamma] = voice_activity_detection(input_signal_abs2, prev_in_abs2, Gamma, noise_abs2, prev_noise_abs2);
    ...
    if (speech == 1)
        new_noise_abs2 = noise_abs2;
        new_sub_noise_abs2 = sub_noise_abs2;
    else
