...
function [frame, new_noise_abs, new_sub_noise_abs, segSNR, speech, p, Xmin, Xtmp, time_counter] = processing_frame(frame, noise_abs, sub_noise_abs, Fs, p, Xmin, Xtmp, time_counter, i, speech)
    ...
    [speech] = voice_activity_detection1(input_signal_abs2, noise_abs2);
